...
public class WizardManager extends Activity {
    ...
    private static final String[] SKIP_ACTIONS = {
        "com.android.setupwizard.CHECKIN",
        "com.android.setupwizard.CHECK_UPDATE",
        "com.android.setupwizard.SYSTEM_UPDATE",
        "com.google.android.setupwizard.SYSTEM_UPDATE",
        "com.android.setupwizard.CHECKING_FOR_UPDATE",
        "com.google.android.gms.phenotype",
        "com.google.android.gms.update"
    };

    private static final String[] SKIP_COMPONENTS = {
        "com.google.android.gms/.update.SystemUpdateActivity",
        "com.google.android.setupwizard/.CheckinActivity",
        "com.google.android.setupwizard/.SystemUpdateActivity",
    ...
    private static boolean isIntentAvailable(Context context, Intent intent) {
        ...
        if (action != null) {
            for (String skipAction : SKIP_ACTIONS) {
                if (action.contains(skipAction)) {
                    Log.v(TAG, "Skipping action: " + action);
                    return false;
                }
            }
        }
        if (component != null) {
            for (String skipComponent : SKIP_COMPONENTS) {
                if (component.contains(skipComponent)) {
                    Log.v(TAG, "Skipping component: " + component);
                    return false;
                }
            }
        }
